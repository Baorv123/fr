...
local NOTIFY_TITLE = "Auto Chest Premium Gbao"
local NOTIFY_ICON = "rbxassetid://83612429080938"
...
Notify("Auto Chest Premium Gbao đã kích hoạt!")
ApplyFPSBoost()
...
local LINK_TO_COPY = "https://discord.gg/Mtkadx9RD"
task.wait(1)
pcall(function()
    setclipboard(LINK_TO_COPY)
end)
warn("Cảm ơn đã sử dụng Auto Chest Premium Gbao")
